...
public class MessageBusConfig {
    ...
    public MessageBus redisMessageBus(StringRedisTemplate redisTemplate,
                                       ...
                                       TunnelManager tunnelManager,
                                       ObjectMapper objectMapper) {
        RedisMessageBus bus = new RedisMessageBus(redisTemplate, redisMessageListenerContainer, objectMapper);
        bus.setTunnelManager(tunnelManager);
        return bus;
    }
    ...
    public WsRelayBus redisWsRelayBus(StringRedisTemplate redisTemplate,
                                      RedisMessageListenerContainer redisMessageListenerContainer) {
        return new RedisWsRelayBus(redisTemplate, redisMessageListenerContainer);
    }
}
